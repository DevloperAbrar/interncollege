  ...
  const loadData = async () => {
    try {
      ...
      if (response.success) {
        ...
        // ── Mentor gate: don't let a student without a mentor reach the
        //    registration flow even by navigating to /student/choice directly ──
        if (!data.student?.assignedMentor?.name) {
